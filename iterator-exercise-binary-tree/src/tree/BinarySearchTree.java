...
public class BinarySearchTree<T extends Comparable<T>> implements IterableCollection<T>, Prototype<T> {
    private Node<T> root;
    private TreeIteratorFactory<T> iteratorFactory;

    public BinarySearchTree(T value) {
        this.root = new Node<>(value);
        this.iteratorFactory = new TreeIteratorFactory<>();
    }
    ...
    public TreeIterator<T> createIterator(String traversalType) {
        return iteratorFactory.createIterator(root, traversalType);
    }

    @Override
    public Prototype<T> clone() {
        try {
            BinarySearchTree<T> clonedTree = new BinarySearchTree<>(root.value);
            return clonedTree;
        } catch (Exception e) {
